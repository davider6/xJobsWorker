...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-welcome-welcome-module"], {
  ...
  function srcAppPagesWelcomeWelcomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _welcome_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./welcome.page */
    ...
    WelcomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["RouterModule"].forChild(routes)],
  ...
  function srcAppPagesWelcomeWelcomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var WelcomePage = /*#__PURE__*/function () {
      function WelcomePage(router, geolocation, ionicStorage, alertController, platform, androidPermissions) {
      ...
      _createClass(WelcomePage, [{
        ...
        value: function location() {
          ...
          this.geolocation.getCurrentPosition().then(function (res) {
            ...
            _this.ionicStorage.set('lastLatitude', _this.latitude.toString());

            _this.ionicStorage.set('lastLongitude', _this.longitude.toString());
          });
        }
      }, {
        key: "camera",
        value: function camera() {
          ...
          if (this.platform.is('cordova')) {
            this.platform.ready().then(function () {
              _this2.androidPermissions.checkPermission(_this2.androidPermissions.PERMISSION.CAMERA).then(function (result) {
              ...
              _this2.androidPermissions.requestPermissions([_this2.androidPermissions.PERMISSION.CAMERA]);
            });
          }
        }
      }, {
        key: "storage",
        value: function storage() {// this.imagePicker
          // .hasReadPermission()
        ...
        key: "slideChanged",
        value: function slideChanged() {// this.slider.lockSwipeToPrev(true).then((res2) => {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 15:
                    ...
                    _context2.next = 18;
                    return this.slider.slideTo(this.step);
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('welcomeSlider', {
      "static": true

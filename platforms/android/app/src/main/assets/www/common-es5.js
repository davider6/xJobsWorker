...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesSubCategoriesSubCategoriesPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesSubCategoriesSubCategoriesPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesSubCategoriesSubCategoriesPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var SubCategoriesPage = /*#__PURE__*/function () {
      function SubCategoriesPage(modalCtrl, apiService, authService, ionicStorage) {
        var _this = this;
        ...
        this.subCategoriesUrl = 'categoryCategoryOccupations/categoryOccupationsByCategoryId?categoryId=';
        ionicStorage.get('token').then(function (val) {
          _this.token = val;
          _this.subCategoriesUrl += _this.categoryId;
      ...
      _createClass(SubCategoriesPage, [{
        ...
        value: function loadSubcategories() {
          ...
          if (!this.authService.categories[this.index].occupations) {
            this.apiService.getEvent(this.subCategoriesUrl, this.token).subscribe(function (resp) {
              _this2.authService.categories[_this2.index].occupations = resp;
            }, function (err) {
        ...
        value: function dismiss() {
          var selected = this.authService.categories[this.index].occupations.filter(function (x) {
            return x.selected;
        ...
        key: "selectOccupation",
        value: function selectOccupation(occupationId) {
          var _this3 = this;

          this.authService.categories[this.index].occupations.forEach(function (occ, idx) {
            if (occ.occupationId === occupationId) {
              _this3.authService.categories[_this3.index].occupations[idx].selected = !_this3.authService.categories[_this3.index].occupations[idx].selected;
            }
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], SubCategoriesPage.prototype, "index", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], SubCategoriesPage.prototype, "categoryId", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], SubCategoriesPage.prototype, "categoryName", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], SubCategoriesPage.prototype, "categoryImage", void 0);
    SubCategoriesPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/sub-categories/sub-categories.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./sub-categories.page.scss */
      "./src/app/pages/sub-categories/sub-categories.page.scss"))["default"]]
    })], SubCategoriesPage);
    /***/
  }
}]);
